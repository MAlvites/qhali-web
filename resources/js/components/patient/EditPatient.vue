<template>
    <div>
        <div class="class-position">Editar paciente</div>
        <v-app>
            <v-card
                max-width="900"
                ...
                <v-card-title>
                    <v-row class="content-item-form -title">
                        <v-col cols="12" sm="12" class="d-flex justify-start align-center">
                            <label>Por favor, edite la siguiente
...
export default {
    ...
    data(){
        return{
            ...
            form: {
                ...
                last_name: this.data.patient.last_name,
                mother_last_name: this.data.patient.mother_last_name,
                nin: this.data.patient.nin,
                age: this.data.patient.age,
                date_birth: this.data.patient.date_birth,
                civil_status: this.data.patient.civil_status,
                birth_sex: this.data.patient.birth_sex,
                sex_orientation: this.data.patient.sex_orientation,
                academic_level: this.data.patient.academic_level,
                profession: this.data.patient.profession,
                employment_situation: this.data.patient.employment_situation,
                address: this.data.patient.address,
                district: this.data.patient.district,
                phone_number: this.data.patient.phone_number,
    ...
    methods: {
        ...
        save() {
            axios.post('/patients/update', this.form)
            .then(response => {
